...
public abstract class FloatingOverlay<TResult> : ContentView
{
    ...
    protected TapGestureRecognizer DismissGesture() =>
        new() { Command = new Command(() => Complete(default)) };
}
