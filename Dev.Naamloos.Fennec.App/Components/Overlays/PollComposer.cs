...
public sealed class PollComposer : FloatingOverlay<PollDraft>
{
                    ...
                    Content = new Grid
                    {
                        ...
                        Children =
                        {
                            new VerticalStackLayout
                            {
                                ...
                                Children =
                                {
                                    new Label { Text = "Create poll", FontSize = 20, FontAttributes = FontAttributes.Bold },
                                    _question,
                                    _validation,
                                    new Grid
                                    {
                                        ...
                                        Children =
                                        {
                                            new Label { Text = "Answers", FontAttributes = FontAttributes.Bold },
                                            new Button { Text = "+ Add answer", BackgroundColor = Colors.Transparent,
                                                Command = new Command(AddAnswer) }
                                                .DynamicResource(Button.TextColorProperty, "Primary").Column(1),
                                        },
                                    },
                                },
                            }.Row(0),
                            ...
                            new Grid
                            {
                                ...
                                Children =
                                {
                                    ...
                                    new Button { Text = "Create poll", Command = new Command(Create) }
    ...
    private void AddAnswer()
    {
        ...
        _answers.Children.Add(new Grid
        {
            ColumnDefinitions = { new ColumnDefinition(GridLength.Star), new ColumnDefinition(GridLength.Auto) },
            Children =
            {
                answer.Column(0),
                new Button { Text = "×", BackgroundColor = Colors.Transparent, WidthRequest = 42,
                    Command = new Command(() => _answers.Children.Remove(answer.Parent as View)) }
                    .DynamicResource(Button.TextColorProperty, "OnSurface").Column(1),
            },
        });
    }
    ...
    private void Create()
    {
        var answers = _answers.Children.OfType<Grid>()
