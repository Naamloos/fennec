...
public sealed partial class MessageBubbleView : ContentView
{
    ...
    public MessageBubbleView()
    {
        var bubble = new Border
        {
            ...
            Behaviors =
            {
                ...
                .Bind(TouchBehavior.LongPressCommandParameterProperty, nameof(Item), source: this),
            },
            Content = new VerticalStackLayout
            {
                ...
                Children =
                {
                    new TextMessageView()
                        ...
                        .Bind(TextMessageView.LinkCommandProperty, nameof(LinkCommand), source: this),

                    new MatrixMedia()
                        .Bind(MatrixMedia.MediaProperty,
                    ...
                    new MessageReactionsView()
                        ...
                        .Bind(MessageReactionsView.AddReactionCommandProperty,
                    ...
                    new CollectionView
                    {
                        ...
                        ItemTemplate = new DataTemplate(() => new MatrixAvatar
                        {
                            Size = 20,
                    ...
                    .Bind(IsVisibleProperty,
                        $"{nameof(Item)}.{nameof(ChatTimelineItem.ReadReceipts)}",
                        converter: new CollectionNotEmptyConverter(), source: this),
                },
            },
        }
        .Bind(HorizontalOptionsProperty,
            $"{nameof(Item)}.{nameof(ChatTimelineItem.IsOwn)}",
            converter: new BooleanToHorizontalOptionsConverter(), source: this)
        ...
        _swipeView.LeftItems.Add(CreateSwipeItem(
            nameof(ReplyCommand)));
    ...
    private static void OnItemChanged(
        ...
        object oldValue,
        object newValue) => ((MessageBubbleView)bindable).UpdateSwipeActions();
