    ...
    IDisposable
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var observableTimeline = new ObservableTimeline(timeline);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            /*
             * PaginateBackwards requests older events. The resulting timeline
             * changes arrive through UpdateEntries as PushFront, Insert,
             * Reset, or other TimelineDiff variants.
             *
    ...
    private void ApplyUpdate(TimelineDiff update)
    {
        switch (update)
        {
            ...
            default:
                Debug.WriteLine(
                    $"Unhandled timeline diff: {update.GetType().FullName}");
                break;
        }
    }
    ...
    private sealed class TimelineEvent : TimelineListener
    {
        ...
        public TimelineEvent(Action<TimelineDiff[]> callback)
        {
