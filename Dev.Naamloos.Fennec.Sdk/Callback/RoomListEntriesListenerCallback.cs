...
public sealed class RoomListEntriesListenerCallback : RoomListEntriesListener
{
    private readonly Action<RoomListEntriesUpdate[]> _callback;
    private readonly SynchronizationContext? _context;

    private RoomListEntriesListenerCallback(Action<RoomListEntriesUpdate[]> callback)
    {
    ...
    public static RoomListEntriesListenerCallback Create(Action<RoomListEntriesUpdate[]> callback)
    {
